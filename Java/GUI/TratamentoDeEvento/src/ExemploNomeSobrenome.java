    ...
    public ExemploNomeSobrenome() {
        ...
        for (int i = 0; i < componentes.size(); i++) {
            ...
            if (i == 4) {
                ...
                // JTextField sobrenomeTextField = (JTextField) componentes.get(3); // Campo
                // Sobrenome
                ...
                /*
                 * 1° - Callback (só funciona nos Tratamentos de Evento que contém APENAS 1
                 * MÉTODO)
                 * 
                 ...
                 * //Evento
                 * resultado.setText(nomeTextField.getText() +" "+
                 * sobrenomeTextField.getText()); //Exibindo o nome completo
                 *
                 * // Limpando os campos
